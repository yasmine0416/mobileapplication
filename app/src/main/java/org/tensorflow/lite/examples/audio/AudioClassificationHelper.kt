...
import org.tensorflow.lite.task.*
...
class AudioClassificationHelper(
    ...
    var previousHour :String="",
    var nbr :Int=0,
    var previousDay: String =LocalDate.now().dayOfMonth.toString()
) {
    ...
    companion object {
        ...
        const val SOUND ="soundclassifier.tflite"
        const val YAMNET_MODEL = "yamnet.tflite"
        const val SOUND_MODEL = "soundclassifier_with_metadataa.tflite"
